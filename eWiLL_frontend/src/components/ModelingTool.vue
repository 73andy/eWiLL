...
import EntityMain from "../components/modelingTool/EntityMain.vue";
import LineMain from "../components/modelingTool/LineMain.vue";
import ModalAddAttributes from "../components/modelingTool/ModalAddAttributes.vue";
